                ...
                <div class="col-md-12">
                    <div class="card card-table-data">
                        <div class="card-header">
                            <h4 class="card-title">Semua Video
                                    ...
                                    <tbody>
                                        <?php foreach ($video as $v) : ?>
                                            <tr>
                                                ...
                                                <td><?= $v->name ?></td>
                                                <td>
                                                    <a href="<?= base_url('video/show/' . $v->video_id) ?>" class="btn btn-success btn-sm">Putar Video</a>
                                                    <a href="#" video_id="<?= $v->video_id ?>" class="btn btn-success btn-sm hapus">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
