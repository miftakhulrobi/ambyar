				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="nav-link dropdown-toggle" href="<?= base_url('message') ?>">
								<i class="fa fa-envelope"></i>
								<?php if ($this->auth->cmessage()) : ?>
									<span class="notification"><?= $this->auth->cmessage() ?></span>
								<?php endif ?>
							</a>
						</li>
						<li class="nav-item dropdown hidden-caret">
							<a class="nav-link" href="<?= base_url('notification') ?>">
								...
								<?php if ($this->auth->cnotification()) : ?>
									<span class="notification"><?= $this->auth->cnotification() ?></span>
								<?php endif ?>
							</a>
						</li>
						<li class="nav-item dropdown hidden-caret">
									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted"><?= $this->auth->user()->email ?></p><a href="<?= base_url('profile') ?>" class="btn btn-xs btn-secondary btn-sm">Profile Saya</a>
											</div>
										</div>
									</li>
									<li>
